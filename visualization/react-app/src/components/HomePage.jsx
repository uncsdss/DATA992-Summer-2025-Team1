          ...
          <section className="bg-white dark:bg-white dark:text-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-300 p-8 mb-16 dark:bg-opacity-95 backdrop-blur-sm space-card glow-border">
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              ...
              <div className="flex items-start space-x-4 p-4 bg-gray-50 dark:bg-white dark:bg-opacity-90 rounded-lg border border-gray-200 dark:border-gray-300 hover:bg-gray-100 dark:hover:bg-white dark:hover:bg-opacity-95 transition-all duration-200 backdrop-blur-sm">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-900 mb-1">Exploratory Data Analysis (EDA)</h3>
              ...
              <div className="flex items-start space-x-4 p-4 bg-gray-50 dark:bg-white dark:bg-opacity-90 rounded-lg border border-gray-200 dark:border-gray-300 hover:bg-gray-100 dark:hover:bg-white dark:hover:bg-opacity-95 transition-all duration-200 backdrop-blur-sm">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 dark:text-gray-700">Use a combination of rule-based and machine learning methods (Facebook BART, WordNet) to generate metadata tags</p>
                </div>
              </div>
              ...
              {showMoreSteps && (
                ...
                <div className="flex-shrink-0 w-10 h-10 bg-green-100 dark:bg-green-600 rounded-full flex items-center justify-center">
                  <span className="text-green-600 dark:text-white text-lg font-bold">5</span>
                </div>
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-900 mb-1">Conduct Full Document Embeddings</h3>
                  <p className="text-gray-700 dark:text-gray-700">Generate embeddings for each text block using BERT-based models</p>
                </div>
              </div>
                  ...
                  <div className="flex items-start space-x-4 p-4 bg-gray-50 dark:bg-white dark:bg-opacity-90 rounded-lg border border-gray-200 dark:border-gray-300 hover:bg-gray-100 dark:hover:bg-white dark:hover:bg-opacity-95 transition-all duration-200 backdrop-blur-sm">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-900 mb-1">Implement Search Integration / Conduct Similarity Search</h3>
